  ...
  return (
    ...
    <div className={`flex flex-col items-center border border-1 p-3 rounded-sm ${error? 'border-red-500':'border-slate-500'}`}>
        ...
        <div className='flex flex-col items-center space-y-3'>
          {imagePath || imagePreview ? (<Avatar src={imagePreview?imagePreview:`/storage/images/${imagePath}` } sx={{ width: 100, height: 100 }} />):(<HiPhotograph className='w-20 h-20 text-slate-500'/>)}
          <Button
            variant="outlined"
            component="label"
