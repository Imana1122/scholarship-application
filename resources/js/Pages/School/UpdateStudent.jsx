...
export default function UpdateStudent(props) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await post(`/student/update/${props.student.id}`, formData, {
        headers: {
  ...
  return (
    <SchoolLayoutComponent currentUser={props.currentUser} title="Update Student">
              ...
              <Grid item xs={6}>
                <FormControl variant="outlined" fullWidth sx={inputCss} required>
                  ...
                  >
                      ...
                      <MenuItem key={props.currentUser.id} value={props.currentUser.id}>
                        {props.currentUser.school_name}
                      </MenuItem>
