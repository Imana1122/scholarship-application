    ...
    return (
      <GuestLayoutComponent scholarship="scholarship">
        <div className="block w-full">
          <div className="flex justify-between rounded-xl bg-blue-900/20">
            {Object.keys(tabContents).map((tabName) => (
              <Link
                ...
                className={classNames(
                  ...
                  activeTab === tabName
                    ? 'bg-green-600 text-white shadow-md ring-green-400'
          ...
          <div className="mt-2">{tabContents[activeTab].content}</div>
        </div>
