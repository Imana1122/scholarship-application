...
class StudentUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'symbol_number' =>['required', Rule::unique('students', 'symbol_number')->ignore($studentId),],
            ...
            'phone_number' => ['required', Rule::unique('students', 'phone_number')->ignore($studentId),'numeric'],
